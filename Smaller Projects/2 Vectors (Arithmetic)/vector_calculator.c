...
//
//Project 2 Vector Calculator
//
//Project 2 is a program that prompts the user with
//a menu of 8 options after creating two user-defined-length
//vectors complete with robust error-checking and recoverability.
...
void displayNegate(int elements, double VectorX[], double VectorY[])
{
		...
		{
			printf("%.21f%s", VectorX[counter++], (counter < elements - 1 ? ", " : ""));
		}
		else
		{
		...
		{
			printf("%.21f%s", VectorY[counter++], (counter < elements - 1 ? ", " : ""));
		}	
		else
		{
